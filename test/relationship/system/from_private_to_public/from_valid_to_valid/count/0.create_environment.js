...
mutation ${operation_name}(
	...
	$entity_whitelist_count: Whitelist_Mutation__Attributes,
	$entity2_whitelist: Whitelist_Mutation__Attributes,
	$entity2_whitelist_count: Whitelist_Mutation__Attributes,
) {
	...
	create_entity(attributes: $entity) {
		...
		mutation {
			...
			count_whitelist: create_whitelist(attributes: $entity_whitelist_count) {
				_metadata {
					type
				}
			}
	...
	entity2: create_entity(attributes: $entity2) {
		...
		mutation {
			...
			count_whitelist: create_whitelist(attributes: $entity2_whitelist_count) {
				_metadata {
					type
				}
			}
