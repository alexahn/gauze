...
mutation ${operation_name}(
	...
	$entity_blacklist_count: Blacklist_Mutation__Attributes,
	$entity2_blacklist: Blacklist_Mutation__Attributes,
	$entity2_blacklist_count: Blacklist_Mutation__Attributes,
	$entity3_blacklist: Blacklist_Mutation__Attributes,
	$entity3_blacklist_count: Blacklist_Mutation__Attributes,
	$entity4_blacklist: Blacklist_Mutation__Attributes,
	$entity4_blacklist_count: Blacklist_Mutation__Attributes,
) {
	create_entity(attributes: $entity) {
		...
		mutation {
			...
			count_blacklist: create_blacklist(attributes: $entity_blacklist_count) {
				_metadata {
					type
				}
			}
	...
	entity2: create_entity(attributes: $entity2) {
		...
		mutation {
			...
			count_blacklist: create_blacklist(attributes: $entity2_blacklist_count) {
				_metadata {
					type
				}
			}
	...
	entity3: create_entity(attributes: $entity3) {
		...
		mutation {
			...
			count_blacklist: create_blacklist(attributes: $entity3_blacklist_count) {
				_metadata {
					type
				}
			}
	...
	entity4: create_entity(attributes: $entity4) {
		...
		mutation {
			...
			count_blacklist: create_blacklist(attributes: $entity4_blacklist_count) {
				_metadata {
					type
				}
			}
