...
mutation ${operation_name}(
	...
	$ytitne_whitelist_count: Whitelist_Mutation__Attributes,
	$ytitne2_whitelist: Whitelist_Mutation__Attributes,
	$ytitne2_whitelist_count: Whitelist_Mutation__Attributes,
	$ytitne3_whitelist: Whitelist_Mutation__Attributes,
	$ytitne3_whitelist_count: Whitelist_Mutation__Attributes,
	$ytitne4_whitelist: Whitelist_Mutation__Attributes,
	$ytitne4_whitelist_count: Whitelist_Mutation__Attributes,
) {
	create_ytitne(attributes: $ytitne) {
		...
		mutation {
			...
			count_whitelist: create_whitelist(attributes: $ytitne_whitelist_count) {
				_metadata {
					type
				}
			}
	...
	ytitne2: create_ytitne(attributes: $ytitne2) {
		...
		mutation {
			...
			count_whitelist: create_whitelist(attributes: $ytitne2_whitelist_count) {
				_metadata {
					type
				}
			}
	...
	ytitne3: create_ytitne(attributes: $ytitne3) {
		...
		mutation {
			...
			count_whitelist: create_whitelist(attributes: $ytitne3_whitelist_count) {
				_metadata {
					type
				}
			}
	...
	ytitne4: create_ytitne(attributes: $ytitne4) {
		...
		mutation {
			...
			count_whitelist: create_whitelist(attributes: $ytitne4_whitelist_count) {
				_metadata {
					type
				}
			}
