	...
	*/
	test.it('create', function (test_ctx) {
		return suite_ctx.database.transaction(function (transaction) {
			const create_query_file = path.resolve(import.meta.dirname, './graphql/create_entity1.graphql')
	...
	test.it('read', function (test_ctx) {
		return suite_ctx.database.transaction(function (transaction) {
			const read_query_file = path.resolve(import.meta.dirname, './graphql/read_entity1.graphql')
	...
	test.it('update', function (test_ctx) {
		...
		return suite_ctx.database.transaction(function (transaction) {
			...
			return execute({
				...
				.then(function () {
					const update_query_file = path.resolve(import.meta.dirname, './graphql/update_entity1.graphql')
	...
	test.it('delete', function (test_ctx) {
		const query_file = path.resolve(import.meta.dirname, './graphql/delete_entity1.graphql')
		const query = fs.readFileSync(query_file).toString('utf8')
		return suite_ctx.database.transaction(function (transaction) {
			const delete_query_file = path.resolve(import.meta.dirname, './graphql/delete_entity1.graphql')
	...
	test.it('create nested relationships', function (test_ctx) {
		return suite_ctx.database.transaction(function (transaction) {
			const create_query_file = path.resolve(import.meta.dirname, './graphql/create_entity1_nested_relationships.graphql')
			const create_query = fs.readFileSync(create_query_file).toString('utf8')
			const source = create_query
	...
	test.it('read nested relationships', function (test_ctx) {
		return suite_ctx.database.transaction(function (transaction) {
			const read_query_file = path.resolve(import.meta.dirname, './graphql/read_entity1_nested_relationships.graphql')
			const read_query = fs.readFileSync(read_query_file).toString('utf8')
			const source = read_query
	...
	test.it('update nested relationships', function (test_ctx) {
		...
		return suite_ctx.database.transaction(function (transaction) {
			const update_query_file = path.resolve(import.meta.dirname, './graphql/update_entity1_nested_relationships.graphql')
			const update_query = fs.readFileSync(update_query_file).toString('utf8')
			const source = update_query
	...
	test.it('delete nested relationships', function (test_ctx) {
		...
		return suite_ctx.database.transaction(function (transaction) {
			const delete_query_file = path.resolve(import.meta.dirname, './graphql/delete_entity1_nested_relationships.graphql')
			const delete_query = fs.readFileSync(delete_query_file).toString('utf8')
			const source = delete_query
