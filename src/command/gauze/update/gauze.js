...
export const describe = "Refresh generated code for an existing builtin Gauze entity";
...
export const builder = function (yargs) {
	return yargs
		...
		.option("entity_file", {
			describe: "Path to the builtin entity config file to update from",
			type: "string",
			requiresArg: true,
		});
	//.wrap(128)
...
export const handler = function (argv) {
	...
	MANAGER.update_gauze(argv.directory, argv.entity_file);
};
