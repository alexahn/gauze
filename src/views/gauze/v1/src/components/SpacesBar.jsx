...
export default function SpacesBar({ route, agentHeader, gauze, model, router, graph, spaces }) {
	...
	const buttonPlainClass = "button-reset bg-transparent bn pa0 w-100 h-100 cx12";
	return (
		<div>
			<div className="workspaces flex flex-column mh-75 overflow-y-auto overflow-x-hidden br4" style={{ width: "100%", maxHeight: "75%" }}>
				<Popover
					containerClassName="bgxyz3 cx12 relative pa2"
					side="right"
					buttonClassName={buttonPlainClass}
					buttonContent={<h1>+</h1>}
					popoverClassName="bgxyz3 cx8 mw6 f4 pa0 bw1 ba truncate-ns"
				>
					<div>
				...
				{Object.keys(spaces).map(function (spaceID, index) {
					...
					const popoverClassName = route.params.space === spaceID ? "bgxyz1 cx12 mw6 w5 f4 pa0 bw1 ba truncate-ns" : "bgxyz3 cx12 mw6 w5 f4 pa0 bw1 ba truncate-ns";
