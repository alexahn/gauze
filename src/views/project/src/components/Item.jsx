...
function Item({pathfinder, services, header, item, mode, variables}) {
	...
	const [localCreateItem, setLocalCreateItem] = useState({ attributes: {} })
	...
	function handleCreate() {
		...
		if (input === expected) {
			setCreateFieldError({})
			setCreateModelError("")
			return gauzemodel.default.create(header, {
	...
	function handleUpdate() {
		...
		if (input === expected) {
			setUpdateFieldError({})
			setUpdateModelError("")
			return gauzemodel.default.update(header, {
				where: {
	...
	function handleDelete() {
		...
		if (input === expected) {
			setDeleteModelError("")
			return gauzemodel.default.delete(header, {
				where: {
					[header.primary_key]: item._metadata.id
				}
			}).then(function (rows) {
	...
	function renderCreate(item) {
		if (item) {
			...
			return (<div key={"create"}><table>
				<thead>
					<tr>
						<th className={cellClass} tabIndex="0">
							<div className={itemClass}>
								<button type="button" className="athelas f6">Create</button>
							</div>
						</th>
				...
				<tbody>
					...
					<tr>
						...
						<td className={cellClass} align="center">
							<div className={itemClass}>
								<button type="button" className="athelas f6" onClick={handleCreate}>Apply</button>
	...
	function renderRead(item) {
		if (item) {
			return (<div key={"read"}><table>
				<thead>
					<tr>
						<th className={cellClass} tabIndex="0">
							<div className={itemClass}>
								<button type="button" className="athelas f6">Read</button>
							</div>
							<span className={tooltipClass}>
								<button type="button" className="athelas f6" onClick={changeMode("read")}>Read</button>
								<button type="button" className="athelas f6" onClick={changeMode("update")}>Update</button>
								<button type="button" className="athelas f6" onClick={changeMode("delete")}>Delete</button>
							</span>
						</th>
						<th className={cellClass}></th>
					</tr>
	...
	function renderUpdate(item) {
		if (item) {
			return (<div key={"update"}><table>
				<thead>
					<tr>
						<th className={cellClass} tabIndex="0">
							<div className={itemClass}>
								<button type="button" className="athelas f6">Update</button>
							</div>
							<span className={tooltipClass}>
								<button type="button" className="athelas f6" onClick={changeMode("read")}>Read</button>
								<button type="button" className="athelas f6" onClick={changeMode("update")}>Update</button>
				...
				<tbody>
					...
					<tr>
						...
						<td className={cellClass} align="center">
							<div className={itemClass}>
								<button type="button" className="athelas f6" onClick={handleUpdate}>Apply</button>
	...
	function renderDelete(item) {
		if (item) {
			return (<div key={"delete"}><table>
				<thead>
					<tr>
						<th className={cellClass} tabIndex="0">
							<div className={itemClass}>
								<button type="button" className="athelas f6">Delete</button>
							</div>
							<span className={tooltipClass}>
								<button type="button" className="athelas f6" onClick={changeMode("read")}>Read</button>
								<button type="button" className="athelas f6" onClick={changeMode("update")}>Update</button>
				...
				<tbody>
					...
					<tr>
						...
						<td className={cellClass} align="center">
							<div className={itemClass}>
								<button type="button" className="athelas f6" onClick={handleDelete}>Apply</button>
