...
const TYPE__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = "WHITELIST";
...
const METADATA__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new GraphQLObjectType({
	name: "Whitelist__Metadata",
	description: "Whitelist Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE,
});

const ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = $abstract.entities.whitelist.default($abstract).graphql_fields;
...
const ATTRIBUTES__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new GraphQLObjectType({
...
const QUERY_QUERY__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new GraphQLObjectType({
...
const MUTATION_MUTATION__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new GraphQLObjectType({
...
const QUERY__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new GraphQLObjectType({
...
const MUTATION__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new GraphQLObjectType({
