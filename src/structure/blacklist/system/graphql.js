...
const QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Blacklist_Query__Relationships",
	description: "Blacklist Query Relationships",
	fields: () => QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
});
...
const MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
...
const MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Blacklist_Mutation__Relationships",
	description: "Blacklist Mutation Relationships",
	fields: () => MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
});
...
const FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
...
const QUERY__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		_metadata: FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE._metadata,
		attributes: FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE.attributes,
		relationships: {
			type: QUERY_RELATIONSHIPS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
...
const MUTATION__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE.attributes,
		relationships: {
			type: MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
			description: "relationships",
		},
		mutation: {
...
export {
	...
	QUERY_RELATIONSHIPS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
	QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
	MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
	MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE,
