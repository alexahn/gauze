...
const METADATA__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE = new GraphQLObjectType({
...
const ATTRIBUTES__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE = new GraphQLObjectType({
...
const QUERY_QUERY__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE = new GraphQLObjectType({
...
const MUTATION_MUTATION__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE = new GraphQLObjectType({
...
const QUERY__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE = new GraphQLObjectType({
...
const MUTATION__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE = new GraphQLObjectType({
