...
const DATABASE_RELATIONSHIPS__RELATIONSHIP__STRUCTURE = {
	...
	[TYPE__GRAPHQL__DATABASE__ENTITY__STRUCTURE]: [TYPE__GRAPHQL__DATABASE__ENTITY__STRUCTURE, TYPE__GRAPHQL__DATABASE__YTITNE__STRUCTURE, TYPE__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE],
