...
const TYPE__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = $abstract.entities.entity1.default($abstract).graphql_meta_type;
...
const METADATA__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Entity1__Metadata",
	description: "Entity1 Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__DATABASE__ENTITY1__STRUCTURE,
});

const ATTRIBUTES_FIELDS__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = $abstract.entities.entity1.default($abstract).graphql_fields;
...
const ATTRIBUTES__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_RELATIONSHIPS__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_QUERY__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_MUTATION__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Entity1_Query",
...
const MUTATION__GRAPHQL__DATABASE__ENTITY1__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
