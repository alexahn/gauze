...
const GRAPHQL_DATABASE_ENTITY1_ATTRIBUTES_FIELDS_ARRAY_STRUCTURE = create_fields_array(GRAPHQL_DATABASE_ENTITY1_ATTRIBUTES_FIELDS_STRUCTURE)
...
const GRAPHQL_DATABASE_ENTITY1_QUERY_QUERY_FIELDS_STRUCTURE = {}

const GRAPHQL_DATABASE_ENTITY1_QUERY_QUERY_STRUCTURE = new GraphQLObjectType({
	name: 'Entity1_Query__Query',
	description: 'Entity1 Query Query',
	fields: () => (GRAPHQL_DATABASE_ENTITY1_QUERY_QUERY_FIELDS_STRUCTURE)
})
...
const GRAPHQL_DATABASE_ENTITY1_MUTATION_MUTATION_FIELDS_STRUCTURE = {}

const GRAPHQL_DATABASE_ENTITY1_MUTATION_MUTATION_STRUCTURE = new GraphQLObjectType({
	name: 'Entity1_Mutation__Mutation',
	description: 'Entity1 Mutation Mutation',
	fields: () => (GRAPHQL_DATABASE_ENTITY1_MUTATION_MUTATION_FIELDS_STRUCTURE)
})
...
const GRAPHQL_DATABASE_ENTITY1_QUERY_STRUCTURE = new GraphQLObjectType({
	...
	fields: () => ({
		...
		query: {
			type: GRAPHQL_DATABASE_ENTITY1_QUERY_QUERY_STRUCTURE,
			description: 'query'
		}
	})
})
...
const GRAPHQL_DATABASE_ENTITY1_MUTATION_STRUCTURE = new GraphQLObjectType({
	...
	fields: () => ({
		...
		mutation: {
			type: GRAPHQL_DATABASE_ENTITY1_MUTATION_MUTATION_STRUCTURE,
...
export {
	...
	GRAPHQL_DATABASE_ENTITY1_ATTRIBUTES_FIELDS_ARRAY_STRUCTURE,
	...
	GRAPHQL_DATABASE_ENTITY1_QUERY_QUERY_STRUCTURE,
	GRAPHQL_DATABASE_ENTITY1_QUERY_QUERY_FIELDS_STRUCTURE,
	GRAPHQL_DATABASE_ENTITY1_MUTATION_MUTATION_STRUCTURE,
