...
const METADATA__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session__Metadata",
	description: "Session Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE = $abstract.entities.session.default($abstract).graphql_attributes_fields;
...
const ATTRIBUTES_FIELDS_STRING__GRAPHQL__SYSTEM__SESSION__STRUCTURE = create_fields_string(ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE);

const ATTRIBUTES__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session__Attributes",
	description: "Session Attributes",
	fields: () => ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_FIELDS_STRING__GRAPHQL__SYSTEM__SESSION__STRUCTURE = create_fields_string(WHERE_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE);

const WHERE__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session__Where",
	description: "Session Where",
	fields: () => WHERE_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session_Query__Relationships_To",
	description: "Session Query Relationships_To",
	fields: () => QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_QUERY__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session_Query__Query",
	description: "Session Query Query",
	fields: () => QUERY_QUERY_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session_Mutation__Relationships_To",
	description: "Session Mutation Relationships To",
	fields: () => MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session_Mutation__Relationships_From",
	description: "Session Mutation Relationships From",
	fields: () => MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
});

const MUTATION_MUTATION_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE = {};

const MUTATION_MUTATION__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Session_Query",
	...
	fields: () => ({
		...
		relationships_to: {
			type: QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
...
const MUTATION__GRAPHQL__SYSTEM__SESSION__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE.attributes,
		relationships_to: {
			type: MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
			description: "relationships from",
		},
		mutation: {
...
export {
	...
	ATTRIBUTES_FIELDS_STRING__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	SOURCE__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	WHERE__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	WHERE_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	WHERE_FIELDS_ARRAY__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	WHERE_FIELDS_STRING__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
	...
	MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__SESSION__STRUCTURE,
