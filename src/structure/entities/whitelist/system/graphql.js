...
const METADATA__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE_METADATA__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Whitelist__Source_Metadata",
	description: "Whitelist Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE,
});

const SOURCE_FIELDS__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = {
	_metadata: {
		type: SOURCE_METADATA__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE,
		description: "Whitelist Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const SOURCE__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Whitelist__Source",
	description: "Whitelist Source",
	fields: () => SOURCE_FIELDS__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE,
});
...
const WHERE__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_QUERY__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_MUTATION__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
export {
	...
	SOURCE__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE,
