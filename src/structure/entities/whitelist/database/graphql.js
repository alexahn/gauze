...
const QUERY_SOURCE_METADATA__GRAPHQL__DATABASE__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Whitelist_Query__Source_Metadata",
	description: "Whitelist Query Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__DATABASE__WHITELIST__STRUCTURE,
});

const QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__WHITELIST__STRUCTURE = {
	_metadata: {
		type: QUERY_SOURCE_METADATA__GRAPHQL__DATABASE__WHITELIST__STRUCTURE,
		description: "Whitelist Query Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const QUERY_SOURCE__GRAPHQL__DATABASE__WHITELIST__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Whitelist_Query__Source",
	description: "Whitelist Query Source",
	fields: () => QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__WHITELIST__STRUCTURE,
});
...
export {
	...
	QUERY_SOURCE__GRAPHQL__DATABASE__WHITELIST__STRUCTURE,
	QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__WHITELIST__STRUCTURE,
