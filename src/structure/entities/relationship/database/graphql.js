...
const WHERE__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Relationship__Where",
	description: "Relationship Where",
	fields: () => WHERE_FIELDS__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE,
});

const QUERY_SOURCE_METADATA__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Relationship_Query__Source_Metadata",
	description: "Relationship Query Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE,
});

const QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE = {
	_metadata: {
		type: QUERY_SOURCE_METADATA__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE,
		description: "Relationship Query Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const QUERY_SOURCE__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Relationship_Query__Source",
	description: "Relationship Query Source",
	fields: () => QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
export {
	...
	QUERY_SOURCE__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE,
	QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__RELATIONSHIP__STRUCTURE,
