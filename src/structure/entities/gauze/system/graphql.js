...
const WHERE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Where",
	description: "Gauze Where",
	fields: () => WHERE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const QUERY_SOURCE_METADATA__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze_Query__Source_Metadata",
	description: "Gauze Query Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = {
	_metadata: {
		type: QUERY_SOURCE_METADATA__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
		description: "Gauze Query Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const QUERY_SOURCE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze_Query__Source",
	description: "Gauze Query Source",
	fields: () => QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Source",
...
export {
	...
	QUERY_SOURCE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
	QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
