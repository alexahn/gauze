...
const METADATA__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Metadata",
	description: "Gauze Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = $abstract.entities.gauze.default($abstract).graphql_attributes_fields;
...
const ATTRIBUTES__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Attributes",
	description: "Gauze Attributes",
	fields: () => ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Source_Metadata",
	description: "Gauze Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const SOURCE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = {
	_metadata: {
		type: SOURCE_METADATA__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
		description: "Gauze Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const SOURCE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Source",
	description: "Gauze Source",
	fields: () => SOURCE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const WHERE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = $abstract.entities.gauze.default($abstract).graphql_where_fields;

const WHERE_FIELDS_ARRAY__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = create_fields_array(WHERE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE);

const WHERE_FIELDS_STRING__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = create_fields_string(WHERE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE);

const WHERE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Where",
	description: "Gauze Where",
	fields: () => WHERE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
});

const QUERY_QUERY_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = {};

const QUERY_QUERY__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_MUTATION__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze_Query",
	description: "Gauze",
	fields: () => ({
		_metadata: {
...
const MUTATION__GRAPHQL__SYSTEM__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze_Mutation",
	description: "Gauze",
	fields: () => ({
		_metadata: {
...
export {
	...
	SOURCE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
	WHERE__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
	WHERE_FIELDS__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
	WHERE_FIELDS_ARRAY__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
	WHERE_FIELDS_STRING__GRAPHQL__SYSTEM__GAUZE__STRUCTURE,
