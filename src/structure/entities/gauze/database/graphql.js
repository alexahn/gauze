...
const METADATA__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Attributes",
	description: "Gauze Attributes",
	fields: () => ATTRIBUTES_FIELDS__GRAPHQL__DATABASE__GAUZE__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Source",
...
const WHERE__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze__Where",
...
const QUERY_QUERY__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_MUTATION__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze_Query",
	description: "Gauze",
	fields: () => ({
		_metadata: {
...
const MUTATION__GRAPHQL__DATABASE__GAUZE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Gauze_Mutation",
	description: "Gauze",
	fields: () => ({
		_metadata: {
