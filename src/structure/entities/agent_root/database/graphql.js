...
const QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Relationships",
	description: "Agent_Root Query Relationships",
	fields: () => QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
});
...
const QUERY_SOURCE_METADATA__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Source_Metadata",
	description: "Agent_Root Query Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
});

const QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: QUERY_SOURCE_METADATA__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
		description: "Agent_Root Query Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const QUERY_SOURCE__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Source",
	description: "Agent_Root Query Source",
	fields: () => QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
});
...
const MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
...
const MUTATION_RELATIONSHIPS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Mutation__Relationships",
	description: "Agent_Root Mutation Relationships",
	fields: () => MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
});
...
const QUERY__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		relationships: {
			type: QUERY_RELATIONSHIPS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
...
const MUTATION__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE.attributes,
		relationships: {
			type: MUTATION_RELATIONSHIPS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
			description: "relationships",
		},
		relationships_to: {
			type: MUTATION_RELATIONSHIPS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
...
export {
	...
	QUERY_SOURCE__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
	QUERY_SOURCE_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
	MUTATION_RELATIONSHIPS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
	MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__AGENT_ROOT__STRUCTURE,
