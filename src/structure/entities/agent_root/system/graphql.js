...
const METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE_METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root__Source_Metadata",
	description: "Agent_Root Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: SOURCE_METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
		description: "Agent_Root Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const SOURCE__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root__Source",
	description: "Agent_Root Source",
	fields: () => SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});
...
const WHERE__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root__Where",
	description: "Agent_Root Where",
	fields: () => WHERE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Relationships_To",
	description: "Agent_Root Query Relationships_To",
	fields: () => QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Relationships_From",
	description: "Agent_Root Query Relationships_From",
	fields: () => QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const QUERY_QUERY_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {};

const QUERY_QUERY__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Mutation__Relationships_To",
	description: "Agent_Root Mutation Relationships To",
	fields: () => MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Mutation__Relationships_From",
	description: "Agent_Root Mutation Relationships From",
	fields: () => MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const MUTATION_MUTATION_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {};

const MUTATION_MUTATION__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		relationships_to: {
			type: QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
...
const MUTATION__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE.attributes,
		relationships_to: {
			type: MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
			description: "relationships from",
		},
		mutation: {
...
export {
	...
	SOURCE__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	...
	QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
