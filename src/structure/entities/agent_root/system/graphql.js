...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_SOURCE_METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Source_Metadata",
	description: "Agent_Root Query Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = {
	_metadata: {
		type: QUERY_SOURCE_METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
		description: "Agent_Root Query Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
		description: "Agent_Root Query Source Direction",
	},
};

const QUERY_SOURCE__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Root_Query__Source",
	description: "Agent_Root Query Source",
	fields: () => QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
export {
	...
	QUERY_SOURCE__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
	QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_ROOT__STRUCTURE,
