...
const SOURCE_METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret__Source",
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_QUERY_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE,
		description: "Secret Query Query Metadata",
	},
};
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_MUTATION_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE,
		description: "Secret Mutation Mutation Metadata",
	},
};
