...
const METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret__Attributes",
	description: "Secret Attributes",
	fields: () => ATTRIBUTES_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret__Source_Metadata",
	description: "Secret Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const SOURCE_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
		type: SOURCE_METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE,
		description: "Secret Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const SOURCE__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret__Source",
	description: "Secret Source",
	fields: () => SOURCE_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});
...
const WHERE__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret__Where",
	description: "Secret Where",
	fields: () => WHERE_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Query__Relationships_To",
	description: "Secret Query Relationships_To",
	fields: () => QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE,
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Query__Relationships_From",
	description: "Secret Query Relationships_From",
	fields: () => QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const QUERY_QUERY_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {};

const QUERY_QUERY__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Query__Query",
	description: "Secret Query Query",
	fields: () => QUERY_QUERY_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Mutation__Relationships_To",
	description: "Secret Mutation Relationships To",
	fields: () => MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__SECRET__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Mutation__Relationships_From",
	description: "Secret Mutation Relationships From",
	fields: () => MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
});

const MUTATION_MUTATION_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE = {};

const MUTATION_MUTATION__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Query",
	...
	fields: () => ({
		...
		relationships_to: {
			type: QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE,
...
const MUTATION__GRAPHQL__DATABASE__SECRET__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE.attributes,
		relationships_to: {
			type: MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE,
			description: "relationships from",
		},
		mutation: {
...
export {
	...
	SOURCE__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	...
	QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__SECRET__STRUCTURE,
	MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__SECRET__STRUCTURE,
