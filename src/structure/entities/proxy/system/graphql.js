...
const QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Proxy_Query__Relationships",
	description: "Proxy Query Relationships",
	fields: () => QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
});
...
const QUERY_SOURCE_METADATA__GRAPHQL__SYSTEM__PROXY__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Proxy_Query__Source_Metadata",
	description: "Proxy Query Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
});

const QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE = {
	_metadata: {
		type: QUERY_SOURCE_METADATA__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
		description: "Proxy Query Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const QUERY_SOURCE__GRAPHQL__SYSTEM__PROXY__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Proxy_Query__Source",
	description: "Proxy Query Source",
	fields: () => QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
});
...
const MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
...
const MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Proxy_Mutation__Relationships",
	description: "Proxy Mutation Relationships",
	fields: () => MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
});
...
const QUERY__GRAPHQL__SYSTEM__PROXY__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		relationships: {
			type: QUERY_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
...
const MUTATION__GRAPHQL__SYSTEM__PROXY__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE.attributes,
		relationships: {
			type: MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
			description: "relationships",
		},
		relationships_to: {
			type: MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
...
export {
	...
	QUERY_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
	QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
	...
	QUERY_SOURCE__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
	QUERY_SOURCE_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
	MUTATION_RELATIONSHIPS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
	MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__SYSTEM__PROXY__STRUCTURE,
