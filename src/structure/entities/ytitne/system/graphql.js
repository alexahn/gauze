...
const METADATA__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne__Attributes",
	description: "Ytitne Attributes",
	fields: () => ATTRIBUTES_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
});

const SOURCE_METADATA__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne__Source",
...
const WHERE__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne__Where",
	description: "Ytitne Where",
	fields: () => WHERE_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
});

const QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne_Query__Relationships_To",
	description: "Ytitne Query Relationships_To",
	fields: () => QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
});

const QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_QUERY__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne_Query__Query",
	description: "Ytitne Query Query",
	fields: () => QUERY_QUERY_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne_Mutation__Relationships_To",
	description: "Ytitne Mutation Relationships To",
	fields: () => MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne_Mutation__Relationships_From",
	description: "Ytitne Mutation Relationships From",
	fields: () => MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
});

const MUTATION_MUTATION_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = {};

const MUTATION_MUTATION__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne_Query",
	...
	fields: () => ({
		...
		relationships_to: {
			type: QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: QUERY_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
...
const MUTATION__GRAPHQL__SYSTEM__YTITNE__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		...
		attributes: FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE.attributes,
		relationships_to: {
			type: MUTATION_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
			description: "relationships to",
		},
		relationships_from: {
			type: MUTATION_RELATIONSHIPS_FROM__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
			description: "relationships from",
		},
		mutation: {
...
export {
	...
	SOURCE__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
	...
	QUERY_RELATIONSHIPS_TO__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
	...
	MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__SYSTEM__YTITNE__STRUCTURE,
