...
const SOURCE_METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY_QUERY_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
		description: "Agent_User Query Query Metadata",
	},
};
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_MUTATION_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
		description: "Agent_User Mutation Mutation Metadata",
	},
};
