...
const METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const SOURCE_METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User__Source_Metadata",
	description: "Agent_User Source Metadata",
	fields: () => METADATA_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});

const SOURCE_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
		type: SOURCE_METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
		description: "Agent_User Source Metadata",
	},
	_direction: {
		type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT($abstract.gauze.types.graphql.graphql.STRING__GRAPHQL__TYPE__GAUZE__ABSTRACT),
...
const SOURCE__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User__Source",
	description: "Agent_User Source",
	fields: () => SOURCE_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});
...
const WHERE__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User__Where",
	description: "Agent_User Where",
	fields: () => WHERE_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});

const QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
...
const QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User_Query__Relationships_To",
	description: "Agent_User Query Relationships_To",
	fields: () => QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});

const QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
...
const QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User_Query__Relationships_From",
	description: "Agent_User Query Relationships_From",
	fields: () => QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});

const QUERY_QUERY_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {};

const QUERY_QUERY__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User_Mutation__Relationships_To",
	description: "Agent_User Mutation Relationships To",
	fields: () => MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});

const MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {
	_metadata: {
		type: METADATA__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
...
const MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_User_Mutation__Relationships_From",
	description: "Agent_User Mutation Relationships From",
	fields: () => MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
});

const MUTATION_MUTATION_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = {};

const MUTATION_MUTATION__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const QUERY__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const MUTATION__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
export {
	...
	SOURCE__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	SOURCE_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	...
	QUERY_RELATIONSHIPS_TO__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	QUERY_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	MUTATION_RELATIONSHIPS_TO__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	MUTATION_RELATIONSHIPS_FROM__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
	MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_USER__STRUCTURE,
