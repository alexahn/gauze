...
const GRAPHQL_TYPE_TO_SQL_PRIMARY_KEY__RESOLVER__STRUCTURE = construct_mapping_from_modules($abstract.entities, "graphql_meta_type", "primary_key");
const SQL_TABLE_TO_SQL_PRIMARY_KEY__RESOLVER__STRUCTURE = construct_mapping_from_modules($abstract.entities, "table_name", "primary_key");
...
export {
	...
	GRAPHQL_TYPE_TO_SQL_PRIMARY_KEY__RESOLVER__STRUCTURE,
	SQL_TABLE_TO_SQL_PRIMARY_KEY__RESOLVER__STRUCTURE,
};
