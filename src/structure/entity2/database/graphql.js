...
const METADATA__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
	name: 'Entity2__Metadata',
	description: 'Entity2 Metadata',
	fields: () => (METADATA_FIELDS__GRAPHQL__DATABASE__ENTITY2__STRUCTURE)
})

const ATTRIBUTES_FIELDS__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = {
	id: {
		type: GraphQLString,
		description: 'id'
	},
...
const ATTRIBUTES__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
...
const QUERY_RELATIONSHIPS__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
...
const QUERY_QUERY__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
...
const MUTATION_RELATIONSHIPS__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
...
const MUTATION_MUTATION__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
...
const QUERY__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
	name: 'Entity2_Query',
...
const MUTATION__GRAPHQL__DATABASE__ENTITY2__STRUCTURE = new GraphQLObjectType({
