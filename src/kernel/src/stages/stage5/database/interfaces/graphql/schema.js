...
import { DATABASE_RELATIONSHIPS__RELATIONSHIP__STRUCTURE } from "./../../../structure/relationships.js";
...
function link() {
	Object.keys(DATABASE_RELATIONSHIPS__RELATIONSHIP__STRUCTURE).forEach(function (entity) {
		var relationships = DATABASE_RELATIONSHIPS__RELATIONSHIP__STRUCTURE[entity];
