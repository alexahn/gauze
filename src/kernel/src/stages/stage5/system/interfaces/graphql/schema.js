...
import { SYSTEM_RELATIONSHIPS__RELATIONSHIP__STRUCTURE } from "./../../../structure/relationships.js";
...
const ENTITIES = {
	...
	[$structure.entities.whitelist.system.graphql.TYPE__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE]: CONNECTION__BLACKLIST__ENTITY__GRAPHQL__INTERFACE__SYSTEM,
};
...
const METHODS = {
	...
	[$structure.entities.whitelist.system.graphql.TYPE__GRAPHQL__SYSTEM__BLACKLIST__STRUCTURE]: METHODS__BLACKLIST__ENTITY__GRAPHQL__INTERFACE__SYSTEM,
};

// todo: add some existence checks and guards to these loops
function link() {
	Object.keys(SYSTEM_RELATIONSHIPS__RELATIONSHIP__STRUCTURE).forEach(function (entity) {
		var relationships = SYSTEM_RELATIONSHIPS__RELATIONSHIP__STRUCTURE[entity];
