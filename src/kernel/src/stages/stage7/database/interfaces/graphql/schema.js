...
const ENTITIES = {
	...
	[$structure.ytitne.database.graphql.TYPE__GRAPHQL__DATABASE__YTITNE__STRUCTURE]: CONNECTION__YTITNE__ENTITY__GRAPHQL__INTERFACE__DATABASE,
	...
	[$structure.blacklist.database.graphql.TYPE__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE]: CONNECTION__BLACKLIST__ENTITY__GRAPHQL__INTERFACE__DATABASE,
	[$structure.entity.database.graphql.TYPE__GRAPHQL__DATABASE__ENTITY__STRUCTURE]: CONNECTION__ENTITY__ENTITY__GRAPHQL__INTERFACE__DATABASE,
	[$structure.gauze.database.graphql.TYPE__GRAPHQL__DATABASE__GAUZE__STRUCTURE]: CONNECTION__GAUZE__ENTITY__GRAPHQL__INTERFACE__DATABASE,
};
...
const METHODS = {
	...
	[$structure.ytitne.database.graphql.TYPE__GRAPHQL__DATABASE__YTITNE__STRUCTURE]: METHODS__YTITNE__ENTITY__GRAPHQL__INTERFACE__DATABASE,
	...
	[$structure.blacklist.database.graphql.TYPE__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE]: METHODS__BLACKLIST__ENTITY__GRAPHQL__INTERFACE__DATABASE,
	[$structure.entity.database.graphql.TYPE__GRAPHQL__DATABASE__ENTITY__STRUCTURE]: METHODS__ENTITY__ENTITY__GRAPHQL__INTERFACE__DATABASE,
	[$structure.gauze.database.graphql.TYPE__GRAPHQL__DATABASE__GAUZE__STRUCTURE]: METHODS__GAUZE__ENTITY__GRAPHQL__INTERFACE__DATABASE,
};
