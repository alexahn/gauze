...
import { SIGN_ENVIRONMENT_JWT__AUTHENTICATION__ENVIRONMENT, SIGN_DATABASE_JWT__AUTHENTICATION__ENVIRONMENT } from "./../../authentication.js";
...
class RealmDatabaseController {
	...
	enter_session(context, scope, parameters) {
		...
		const dependencies = {
			...
			realm: "database",
			sign_jwt: SIGN_DATABASE_JWT__AUTHENTICATION__ENVIRONMENT,
		};
