...
class SecretEnvironmentModel extends $kernel.src.models.environment.EnvironmentModel {
	...
	create(context, scope, parameters) {
		...
		const realm = {
			...
			operation: {
				operation: $operations.secret.CREATE__SECRET__OPERATION__GRAPHQL__INTERFACE__ENVIRONMENT,
