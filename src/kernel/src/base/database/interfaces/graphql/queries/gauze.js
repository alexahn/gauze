...
const caf5342ac38d41a6a02bb81d2d2b21a4_PARENT_QUERY_INTERFACE_DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const caf5342ac38d41a6a02bb81d2d2b21a4_ATTRIBUTES_QUERY_INTERFACE_DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const caf5342ac38d41a6a02bb81d2d2b21a4_ATTRIBUTES_ARRAY_QUERY_INTERFACE_DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const READ__caf5342ac38d41a6a02bb81d2d2b21a4__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	type: new $abstract.gauze.types.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT(
		$structure.a543731262804f64adcc0eae1a225acc.database.graphql.QUERY__GRAPHQL__DATABASE__caf5342ac38d41a6a02bb81d2d2b21a4__STRUCTURE,
	),
	args: {
		parent: {
			description: "parent",
			type: caf5342ac38d41a6a02bb81d2d2b21a4_PARENT_QUERY_INTERFACE_DATABASE,
		},
		where: {
			description: "where",
	...
	resolve: (_source, query_arguments, context) => {
		...
		return caf5342ac38d41a6a02bb81d2d2b21a4_CONTROLLER_DATABASE
			.read(
				{
					source: _source,
