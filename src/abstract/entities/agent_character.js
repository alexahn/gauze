	...
	const ENTITY = {
		...
		fields: {
			gauze__agent_character__id: {
				...
				description: "id",
				pre_serialize_middlewares: [$abstract.gauze.middlewares.RUD_PROTECTED__MIDDLEWARE__GAUZE__ABSTRACT("gauze__agent_character__id")],
				serializers: [],
		...
		methods: {
			create: {
				name: "create",
				privacy: "private",
				valid_agent_types: ["gauze__agent_character"],
			},
			read: {
				name: "read",
				privacy: "private",
