...
const METHODS__WHITELIST__ENTITY__GRAPHQL__INTERFACE__SYSTEM = {
	query: {
		...
		cursor_read_whitelist: CURSOR_READ__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
		count_whitelist: COUNT__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	},
	mutation: {
		...
		cursor_update_whitelist: CURSOR_UPDATE__WHITELIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		delete_whitelist: DELETE__WHITELIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		cursor_delete_whitelist: CURSOR_DELETE__WHITELIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
	},
};
