...
const METHODS__BLACKLIST__ENTITY__GRAPHQL__INTERFACE__SYSTEM = {
	query: {
		...
		cursor_read_blacklist: CURSOR_READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
		count_blacklist: COUNT__BLACKLIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	},
	mutation: {
		...
		cursor_update_blacklist: CURSOR_UPDATE__BLACKLIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		delete_blacklist: DELETE__BLACKLIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		cursor_delete_blacklist: CURSOR_DELETE__BLACKLIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
	},
};
