...
const SERIALIZER__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = new $structure.serializers.GraphQLSerializer({
...
const PARENT__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CREATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	type: new $abstract.gauze.types.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entity.system.graphql.MUTATION__GRAPHQL__SYSTEM__ENTITY__STRUCTURE),
	args: {
		...
		parent: {
			description: "parent",
			type: PARENT__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
		attributes: {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
...
const UPDATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	args: {
		...
		where_in: {
			...
			type: ATTRIBUTES_ARRAY__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
		where_not_in: {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
...
const DELETE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
