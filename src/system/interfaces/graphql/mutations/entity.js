...
const CREATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		...
		return CONTROLLER__ENTITY__CONTROLLER__SYSTEM.create(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "CREATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
...
const UPDATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__ENTITY__CONTROLLER__SYSTEM.update(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "UPDATE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data.map(SERIALIZER__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};
...
const DELETE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__ENTITY__CONTROLLER__SYSTEM.delete(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "DELETE__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data.map(SERIALIZER__ENTITY__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};
