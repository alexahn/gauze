...
const WHITELIST_MUTATION_ATTRIBUTES = new GraphQLInputObjectType({
...
const CREATE__WHITELIST__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	type: new GraphQLList($structure.whitelist.system.graphql.MUTATION__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE),
	args: {
		attributes: {
