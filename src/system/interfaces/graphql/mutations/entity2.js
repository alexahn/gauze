...
const CREATE__ENTITY2__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, mutation_arguments, context) => {
		...
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write('0', __RELATIVE_FILEPATH, 'CREATE__ENTITY2__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter', 'mutation_arguments', mutation_arguments)
...
const UPDATE__ENTITY2__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, mutation_arguments, context) => {
		...
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write('0', __RELATIVE_FILEPATH, 'UPDATE__ENTITY2__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter', 'mutation_arguments', mutation_arguments)
...
const DELETE__ENTITY2__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, mutation_arguments, context) => {
		...
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write('0', __RELATIVE_FILEPATH, 'DELETE__ENTITY2__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter', 'mutation_arguments', mutation_arguments)
