...
const PARENT__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CREATE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	args: {
		...
		parent: {
			description: "parent",
			type: PARENT__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
		attributes: {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
		...
		return CONTROLLER__AGENT_ROOT__CONTROLLER__SYSTEM.create(
			...
			$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "CREATE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
...
const UPDATE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	args: {
		...
		where_in: {
			...
			type: ATTRIBUTES_ARRAY__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
		where_not_in: {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__AGENT_ROOT__CONTROLLER__SYSTEM.update(
			...
			$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "UPDATE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data.map(SERIALIZER__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};
...
const DELETE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__AGENT_ROOT__CONTROLLER__SYSTEM.delete(
			...
			$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "DELETE__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data.map(SERIALIZER__AGENT_ROOT__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};
