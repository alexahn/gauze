...
const CURSOR_PAGE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.ytitne.system.graphql.MUTATION__GRAPHQL__SYSTEM__YTITNE__STRUCTURE),
			),
		},
		page_info: {
...
const CURSOR_UPDATE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	type: CURSOR_PAGE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, mutation_arguments, context) => {
		...
		return CONTROLLER__YTITNE__CONTROLLER__SYSTEM.cursor_update(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize),
...
const CURSOR_DELETE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	type: CURSOR_PAGE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, mutation_arguments, context) => {
		return CONTROLLER__YTITNE__CONTROLLER__SYSTEM.cursor_delete(
			context,
			{
				source,
			},
...
export {
	...
	CURSOR_UPDATE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
	DELETE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
	CURSOR_DELETE__YTITNE__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
};
