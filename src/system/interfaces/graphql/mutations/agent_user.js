...
const CREATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		...
		return CONTROLLER__AGENT_USER__CONTROLLER__SYSTEM.create(
			...
			return data.map(function (record) {
				return SERIALIZER__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize(source, record);
			});
		});
	},
};
...
const UPDATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
...
const DELETE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
