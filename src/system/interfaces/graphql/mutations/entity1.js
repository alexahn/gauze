...
const PARENT__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CREATE__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	args: {
		...
		parent: {
			description: "parent",
			type: PARENT__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
		attributes: {
			description: "attributes",
			type: ATTRIBUTES__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
	},
	resolve: (_source, mutation_arguments, context) => {
		...
		return CONTROLLER__ENTITY1__CONTROLLER__SYSTEM.create(
			{
				source: _source,
			...
			return data.map(SERIALIZER__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};
...
const UPDATE__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	args: {
		...
		where_in: {
			...
			type: ATTRIBUTES_ARRAY__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM,
		},
		where_not_in: {
	...
	resolve: (_source, mutation_arguments, context) => {
		...
		return CONTROLLER__ENTITY1__CONTROLLER__SYSTEM.update(
			{
				source: _source,
				database: context.database,
				transaction: context.transaction,
...
const DELETE__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, mutation_arguments, context) => {
		...
		return CONTROLLER__ENTITY1__CONTROLLER__SYSTEM.delete(
			{
				source: _source,
				database: context.database,
				transaction: context.transaction,
...
export { CREATE__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM, UPDATE__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM, DELETE__ENTITY1__MUTATION__GRAPHQL__INTERFACE__SYSTEM };
