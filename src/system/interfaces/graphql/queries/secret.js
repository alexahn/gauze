...
const CURSOR_PAGE__SECRET__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.secret.system.graphql.QUERY__GRAPHQL__SYSTEM__SECRET__STRUCTURE),
			),
		},
		page_info: {
...
const CURSOR_READ__SECRET__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	type: CURSOR_PAGE__SECRET__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		return CONTROLLER__SECRET__CONTROLLER__SYSTEM.cursor_read(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__SECRET__QUERY__GRAPHQL__INTERFACE__SYSTEM.serialize),
...
export {
	...
	CURSOR_READ__SECRET__QUERY__GRAPHQL__INTERFACE__SYSTEM,
