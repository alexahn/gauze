...
const READ__ENTITY2__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (_source, query_arguments, context) => {
		...
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "READ__ENTITY2__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "access:agent_id", context.agent_id);
