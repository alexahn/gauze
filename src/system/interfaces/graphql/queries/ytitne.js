...
const SOURCE__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_STRING__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_ARRAY__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_STRING__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CURSOR_PAGE__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.ytitne.system.graphql.QUERY__GRAPHQL__SYSTEM__YTITNE__STRUCTURE),
			),
		},
		page_info: {
...
const READ__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	type: new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.ytitne.system.graphql.QUERY__GRAPHQL__SYSTEM__YTITNE__STRUCTURE),
	args: {
		source: {
			description: "source",
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "READ__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		...
		return CONTROLLER__YTITNE__CONTROLLER__SYSTEM.read(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("1", __RELATIVE_FILEPATH, "READ__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data.map(SERIALIZER__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};

const CURSOR_READ__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	type: CURSOR_PAGE__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		return CONTROLLER__YTITNE__CONTROLLER__SYSTEM.cursor_read(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM.serialize),
...
const COUNT__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, query_arguments, context) => {
		...
		return CONTROLLER__YTITNE__CONTROLLER__SYSTEM.count(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("1", __RELATIVE_FILEPATH, "COUNT__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data;
		});
	},
};
export {
	...
	SOURCE__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_ARRAY__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_STRING__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_ARRAY__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_STRING__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	// top level
	READ__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	CURSOR_READ__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	COUNT__YTITNE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
};
