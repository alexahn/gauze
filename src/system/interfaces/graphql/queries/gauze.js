...
const READ__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, query_arguments, context) => {
		...
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"READ__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:enter",
			"query_arguments",
			query_arguments,
		);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
...
export {
	...
	SOURCE__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_ARRAY__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_STRING__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_ARRAY__GAUZE__QUERY__GRAPHQL__INTERFACE__SYSTEM,
