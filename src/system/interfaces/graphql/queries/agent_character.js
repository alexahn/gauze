...
const SOURCE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Character_Query__Source",
	description: "Agent_Character Source",
	fields: () => $structure.entities.agent_character.system.graphql.SOURCE_FIELDS__GRAPHQL__SYSTEM__AGENT_CHARACTER__STRUCTURE,
});

const ATTRIBUTES__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_STRING__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_ARRAY__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_STRING__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CURSOR_PAGE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Character_Query__Cursor_Page",
	description: "Agent_Character Query Cursor Page",
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT(
					$structure.entities.agent_character.system.graphql.QUERY__GRAPHQL__SYSTEM__AGENT_CHARACTER__STRUCTURE,
				),
			),
		},
		page_info: {
...
const READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		...
		return CONTROLLER__AGENT_CHARACTER__CONTROLLER__SYSTEM.read(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("1", __RELATIVE_FILEPATH, "READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data.map(SERIALIZER__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM.serialize);
		});
	},
};

const CURSOR_READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	type: CURSOR_PAGE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		return CONTROLLER__AGENT_CHARACTER__CONTROLLER__SYSTEM.cursor_read(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM.serialize),
...
const COUNT__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "COUNT__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__AGENT_CHARACTER__CONTROLLER__SYSTEM.count(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("1", __RELATIVE_FILEPATH, "COUNT__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:success", "data", data);
			return data;
		});
	},
};
export {
	...
	SOURCE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_ARRAY__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_STRING__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_ARRAY__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_STRING__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	// top level
	READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	CURSOR_READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	COUNT__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__SYSTEM,
};
