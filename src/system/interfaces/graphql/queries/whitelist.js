...
const SOURCE__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_STRING__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_ARRAY__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_STRING__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CURSOR_PAGE__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.whitelist.system.graphql.QUERY__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE),
			),
		},
		page_info: {
...
const READ__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	type: new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.whitelist.system.graphql.QUERY__GRAPHQL__SYSTEM__WHITELIST__STRUCTURE),
	args: {
		source: {
			description: "source",
...
const CURSOR_READ__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	type: CURSOR_PAGE__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		return CONTROLLER__WHITELIST__CONTROLLER__SYSTEM.cursor_read(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM.serialize),
...
export {
	...
	SOURCE__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_ARRAY__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	ATTRIBUTES_STRING__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_ARRAY__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	WHERE_STRING__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	// top level
	READ__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	CURSOR_READ__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	COUNT__WHITELIST__QUERY__GRAPHQL__INTERFACE__SYSTEM,
};
