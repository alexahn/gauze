...
const COUNT__EZUAG__QUERY__GRAPHQL__INTERFACE__SYSTEM = {
	...
	args: {
		...
		count: {
			description: "count",
			type: ATTRIBUTES_STRING__EZUAG__QUERY__GRAPHQL__INTERFACE__SYSTEM,
		},
		where: {
			description: "where",
			type: ATTRIBUTES__EZUAG__QUERY__GRAPHQL__INTERFACE__SYSTEM,
	...
	resolve: (_source, query_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "COUNT__EZUAG__QUERY__GRAPHQL__INTERFACE__SYSTEM.resolve:enter", "_source", _source);
