...
class Agent_CharacterSystemModel extends $kernel.src.models.system.SystemModel {
...
const CONFIG__AGENT_CHARACTER__MODEL__SYSTEM = {
	schema: $database.interfaces.graphql.schema.SCHEMA__SCHEMA__GRAPHQL__INTERFACE__DATABASE,
	schema_name: "SCHEMA__SCHEMA__GRAPHQL__INTERFACE__DATABASE",
	relationship_model: MODEL__RELATIONSHIP__MODEL__SYSTEM,
};
const MODEL__AGENT_CHARACTER__MODEL__SYSTEM = new Agent_CharacterSystemModel(ROOT_CONFIG__AGENT_CHARACTER__MODEL__SYSTEM, CONFIG__AGENT_CHARACTER__MODEL__SYSTEM);

export { MODEL__AGENT_CHARACTER__MODEL__SYSTEM };
