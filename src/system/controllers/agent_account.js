...
class AgentAccountSystemController extends $kernel.src.controllers.system.SystemController {
...
const CONTROLLER__AGENT_ACCOUNT__CONTROLLER__SYSTEM = new AgentAccountSystemController(ROOT_CONFIG__AGENT_ACCOUNT__CONTROLLER__SYSTEM, CONFIG__AGENT_ACCOUNT__CONTROLLER__SYSTEM);
