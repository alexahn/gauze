...
class Agent_AccountDatabaseController extends $kernel.src.controllers.database.DatabaseController {
...
const CONTROLLER__AGENT_ACCOUNT__CONTROLLER__DATABASE = new Agent_AccountDatabaseController(ROOT_CONFIG__AGENT_ACCOUNT__CONTROLLER__DATABASE, CONFIG__AGENT_ACCOUNT__CONTROLLER__DATABASE);
