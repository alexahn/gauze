...
class AgentRootDatabaseController extends $kernel.src.controllers.database.DatabaseController {
...
const CONTROLLER__AGENT_ROOT__CONTROLLER__DATABASE = new AgentRootDatabaseController(ROOT_CONFIG__AGENT_ROOT__CONTROLLER__DATABASE, CONFIG__AGENT_ROOT__CONTROLLER__DATABASE);
