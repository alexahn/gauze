...
const SERIALIZER__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $structure.gauze.serializers.GraphQLSerializer({
...
const SOURCE__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_STRING__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_ARRAY__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_STRING__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CURSOR_PAGE__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Agent_Account_Query__Cursor_Page",
	description: "Agent_Account Query Cursor Page",
	fields: () => ({
		nodes: {
...
const READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	...
	args: {
		source: {
			description: "source",
			type: SOURCE__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where: {
			description: "where",
			type: WHERE__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where_in: {
			description: "where in",
			type: WHERE_ARRAY__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		cache_where_in: {
			description: "cache where in",
			type: WHERE_STRING__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where_not_in: {
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"query_arguments",
			query_arguments,
		);
		...
		return CONTROLLER__AGENT_ACCOUNT__CONTROLLER__DATABASE.read(
			context,
			{
				source,
			},
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("1", __RELATIVE_FILEPATH, "READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data.map(SERIALIZER__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.serialize);
		});
	},
};

const CURSOR_READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"source",
			source,
		);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
		...
		return CONTROLLER__AGENT_ACCOUNT__CONTROLLER__DATABASE.cursor_read(
			context,
			{
				source,
			},
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
				"1",
				__RELATIVE_FILEPATH,
				"CURSOR_READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success",
				"page",
				page,
			);
			return {
				nodes: page.nodes.map(SERIALIZER__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.serialize),
...
const COUNT__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "COUNT__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"COUNT__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"query_arguments",
			query_arguments,
		);
		if (!query_arguments.where && !query_arguments.where_in && !query_arguments.where_not_in && !query_arguments.where_like && !query_arguments.where_between) {
		...
		return CONTROLLER__AGENT_ACCOUNT__CONTROLLER__DATABASE.count(
			context,
			{
				source,
			},
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("1", __RELATIVE_FILEPATH, "COUNT__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data;
		});
	},
};
...
export {
	READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_READ__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
	COUNT__AGENT_ACCOUNT__QUERY__GRAPHQL__INTERFACE__DATABASE,
};
