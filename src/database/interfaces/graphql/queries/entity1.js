...
const SERIALIZER__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE = new $structure.serializers.GraphQLSerializer({
...
const PARENT__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const READ__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	...
	args: {
		parent: {
			description: "parent",
			type: PARENT__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where: {
			description: "where",
			type: ATTRIBUTES__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where_in: {
			description: "where in",
			type: ATTRIBUTES_ARRAY__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where_not_in: {
	...
	resolve: (_source, query_arguments, context) => {
		...
		return CONTROLLER__ENTITY1__CONTROLLER__DATABASE.read(
			{
				source: _source,
			...
			return data.map(SERIALIZER__ENTITY1__QUERY__GRAPHQL__INTERFACE__DATABASE.serialize);
		});
	},
};
