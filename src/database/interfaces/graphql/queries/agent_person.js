...
const READ__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "READ__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		...
		return CONTROLLER__AGENT_PERSON__CONTROLLER__DATABASE.read(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("1", __RELATIVE_FILEPATH, "READ__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
...
const COUNT__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "COUNT__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__AGENT_PERSON__CONTROLLER__DATABASE.count(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("1", __RELATIVE_FILEPATH, "COUNT__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data;
		});
	},
};
