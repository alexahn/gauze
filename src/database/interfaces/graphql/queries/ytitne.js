...
const YTITNE_PARENT_QUERY_INTERFACE_DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Ytitne__Parent",
	description: "Ytitne Parent",
	fields: () => $structure.ytitne.database.graphql.METADATA_FIELDS__GRAPHQL__DATABASE__YTITNE__STRUCTURE,
});

const YTITNE_ATTRIBUTES_QUERY_INTERFACE_DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const YTITNE_ATTRIBUTES_ARRAY_QUERY_INTERFACE_DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const READ__YTITNE__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	...
	args: {
		parent: {
			description: "parent",
			type: YTITNE_PARENT_QUERY_INTERFACE_DATABASE,
		},
		where: {
			description: "where",
			type: YTITNE_ATTRIBUTES_QUERY_INTERFACE_DATABASE,
		},
		where_in: {
			description: "where in",
			type: YTITNE_ATTRIBUTES_ARRAY_QUERY_INTERFACE_DATABASE,
		},
		where_not_in: {
	...
	resolve: (_source, query_arguments, context) => {
		...
		return YTITNE_CONTROLLER_DATABASE.read(
			{
				source: _source,
