...
const SERIALIZER__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE = new $structure.serializers.GraphQLSerializer({
	graphql_type: $structure.gauze.database.graphql.TYPE__GRAPHQL__DATABASE__GAUZE__STRUCTURE,
...
const PARENT__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => $structure.gauze.database.graphql.METADATA_FIELDS__GRAPHQL__DATABASE__GAUZE__STRUCTURE,
});
...
const ATTRIBUTES__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: $structure.gauze.database.graphql.ATTRIBUTES_FIELDS__GRAPHQL__DATABASE__GAUZE__STRUCTURE,
});
...
const ATTRIBUTES_ARRAY__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: $structure.gauze.database.graphql.ATTRIBUTES_FIELDS_ARRAY__GRAPHQL__DATABASE__GAUZE__STRUCTURE,
});

const READ__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	type: new $abstract.gauze.types.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.gauze.database.graphql.QUERY__GRAPHQL__DATABASE__GAUZE__STRUCTURE),
	args: {
		parent: {
			description: "parent",
		...
		where: {
			description: "where",
			type: ATTRIBUTES__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where_in: {
			description: "where in",
			type: ATTRIBUTES_ARRAY__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE,
		},
		where_not_in: {
...
export { READ__GAUZE__QUERY__GRAPHQL__INTERFACE__DATABASE };
