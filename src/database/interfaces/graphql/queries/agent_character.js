...
const CURSOR_PAGE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CURSOR_READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"source",
			source,
		);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
		...
		return CONTROLLER__AGENT_CHARACTER__CONTROLLER__DATABASE.cursor_read(
			context,
			{
				source,
			},
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
				"1",
				__RELATIVE_FILEPATH,
				"CURSOR_READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success",
				"page",
				page,
			);
			return {
				nodes: page.nodes.map(SERIALIZER__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE.serialize),
...
export {
	READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_READ__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE,
	COUNT__AGENT_CHARACTER__QUERY__GRAPHQL__INTERFACE__DATABASE,
};
