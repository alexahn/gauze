...
const CURSOR_PAGE__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	...
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.blacklist.database.graphql.QUERY__GRAPHQL__DATABASE__BLACKLIST__STRUCTURE),
			),
		},
		page_info: {
...
const CURSOR_READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, query_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "CURSOR_READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"query_arguments",
			query_arguments,
		);
		if (
		...
		return CONTROLLER__BLACKLIST__CONTROLLER__DATABASE.cursor_read(
			context,
			{
				source,
			},
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
				"1",
				__RELATIVE_FILEPATH,
				"CURSOR_READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE.resolve:success",
				"page",
				page,
			);
			return {
				nodes: page.nodes.map(SERIALIZER__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE.serialize),
...
export { READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE, CURSOR_READ__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE, COUNT__BLACKLIST__QUERY__GRAPHQL__INTERFACE__DATABASE };
