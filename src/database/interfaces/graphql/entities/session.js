...
import {
	READ__SESSION__QUERY__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_READ__SESSION__QUERY__GRAPHQL__INTERFACE__DATABASE,
	COUNT__SESSION__QUERY__GRAPHQL__INTERFACE__DATABASE,
...
const METHODS__SESSION__ENTITY__GRAPHQL__INTERFACE__DATABASE = {
	query: {
		...
		cursor_read_session: CURSOR_READ__SESSION__QUERY__GRAPHQL__INTERFACE__DATABASE,
	...
	mutation: {
		...
		cursor_update_session: CURSOR_UPDATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		delete_session: DELETE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		cursor_delete_session: CURSOR_DELETE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	},
};
