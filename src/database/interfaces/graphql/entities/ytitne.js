...
import {
	READ__YTITNE__QUERY__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_READ__YTITNE__QUERY__GRAPHQL__INTERFACE__DATABASE,
	COUNT__YTITNE__QUERY__GRAPHQL__INTERFACE__DATABASE,
...
const METHODS__YTITNE__ENTITY__GRAPHQL__INTERFACE__DATABASE = {
	query: {
		...
		cursor_read_ytitne: CURSOR_READ__YTITNE__QUERY__GRAPHQL__INTERFACE__DATABASE,
	...
	mutation: {
		...
		cursor_update_ytitne: CURSOR_UPDATE__YTITNE__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		delete_ytitne: DELETE__YTITNE__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		cursor_delete_ytitne: CURSOR_DELETE__YTITNE__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	},
};
