...
import { READ__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE, COUNT__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE } from "./../queries/agent_person.js";
import {
...
const CONNECTION__AGENT_PERSON__ENTITY__GRAPHQL__INTERFACE__DATABASE = {
	...
	query_relationships_to: $structure.entities.agent_person.database.graphql.QUERY_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_PERSON__STRUCTURE,
	query_relationships_from: $structure.entities.agent_person.database.graphql.QUERY_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_PERSON__STRUCTURE,
	...
	mutation_relationships_to: $structure.entities.agent_person.database.graphql.MUTATION_RELATIONSHIPS_TO_FIELDS__GRAPHQL__DATABASE__AGENT_PERSON__STRUCTURE,
	mutation_relationships_from: $structure.entities.agent_person.database.graphql.MUTATION_RELATIONSHIPS_FROM_FIELDS__GRAPHQL__DATABASE__AGENT_PERSON__STRUCTURE,
...
const METHODS__AGENT_PERSON__ENTITY__GRAPHQL__INTERFACE__DATABASE = {
	query: {
		...
		count_agent_person: COUNT__AGENT_PERSON__QUERY__GRAPHQL__INTERFACE__DATABASE,
	},
	mutation: {
