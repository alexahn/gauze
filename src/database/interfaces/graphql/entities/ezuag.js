...
const CONNECTION__EZUAG__ENTITY__GRAPHQL__INTERFACE__DATABASE = {
	query_relationships: $structure.ezuag.database.graphql.QUERY_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__EZUAG__STRUCTURE,
	mutation_relationships: $structure.ezuag.database.graphql.MUTATION_RELATIONSHIPS_FIELDS__GRAPHQL__DATABASE__EZUAG__STRUCTURE,
	query_query: $structure.ezuag.database.graphql.QUERY_QUERY_FIELDS__GRAPHQL__DATABASE__EZUAG__STRUCTURE,
	mutation_mutation: $structure.ezuag.database.graphql.MUTATION_MUTATION_FIELDS__GRAPHQL__DATABASE__EZUAG__STRUCTURE,
};
