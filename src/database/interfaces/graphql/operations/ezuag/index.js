...
const CURSOR_READ_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE = "CursorReadEzuag";
const CURSOR_READ__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE = fs.readFileSync(path.resolve(import.meta.dirname, "./cursor_read.graphql"), {
	encoding: "utf8",
});
...
const CURSOR_UPDATE_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE = "CursorUpdateEzuag";
const CURSOR_UPDATE__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE = fs.readFileSync(path.resolve(import.meta.dirname, "./cursor_update.graphql"), {
	encoding: "utf8",
});
...
const CURSOR_DELETE_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE = "CursorDeleteEzuag";
const CURSOR_DELETE__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE = fs.readFileSync(path.resolve(import.meta.dirname, "./cursor_delete.graphql"), {
	encoding: "utf8",
});
...
export {
	...
	CURSOR_READ_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_READ__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	UPDATE_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	UPDATE__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_UPDATE_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_UPDATE__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	DELETE_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	DELETE__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_DELETE_NAME__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_DELETE__EZUAG__OPERATION__GRAPHQL__INTERFACE__DATABASE,
