...
const PARENT__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CREATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	args: {
		parent: {
			description: "parent",
			type: PARENT__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		},
		attributes: {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "_source", _source);
...
const UPDATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	args: {
		...
		where_in: {
			...
			type: ATTRIBUTES_ARRAY__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		},
		cache_where_in: {
			description: "cache where in",
			type: ATTRIBUTES_STRING__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE,
		},
		where_not_in: {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "_source", _source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
...
const DELETE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (_source, mutation_arguments, context) => {
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__AGENT_USER__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "_source", _source);
		$kernel.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
