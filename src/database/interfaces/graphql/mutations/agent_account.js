...
const CURSOR_PAGE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
		...
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT(
					$structure.entities.agent_account.database.graphql.MUTATION__GRAPHQL__DATABASE__AGENT_ACCOUNT__STRUCTURE,
				),
			),
		},
		page_info: {
...
const CURSOR_UPDATE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_UPDATE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"source",
			source,
		);
		...
		return CONTROLLER__AGENT_ACCOUNT__CONTROLLER__DATABASE.cursor_update(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE.serialize),
...
const CURSOR_DELETE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_DELETE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"source",
			source,
		);
		if (
		...
		return CONTROLLER__AGENT_ACCOUNT__CONTROLLER__DATABASE.cursor_delete(
			context,
			{
				source,
			},
...
export {
	...
	CURSOR_UPDATE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	DELETE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_DELETE__AGENT_ACCOUNT__MUTATION__GRAPHQL__INTERFACE__DATABASE,
};
