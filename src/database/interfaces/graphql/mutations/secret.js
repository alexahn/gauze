...
const SOURCE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_ARRAY__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const ATTRIBUTES_STRING__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_ARRAY__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const WHERE_STRING__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.INPUT_OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
...
const CURSOR_PAGE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = new $abstract.gauze.types.graphql.graphql.OBJECT__GRAPHQL__TYPE__GAUZE__ABSTRACT({
	name: "Secret_Mutation__Cursor_Page",
	description: "Secret Mutation Cursor Page",
	fields: () => ({
		nodes: {
			type: new $abstract.gauze.types.graphql.graphql.NON_NULL__GRAPHQL__TYPE__GAUZE__ABSTRACT(
				new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.secret.database.graphql.MUTATION__GRAPHQL__DATABASE__SECRET__STRUCTURE),
			),
		},
		page_info: {
...
const CREATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	type: new $abstract.gauze.types.graphql.graphql.LIST__GRAPHQL__TYPE__GAUZE__ABSTRACT($structure.entities.secret.database.graphql.MUTATION__GRAPHQL__DATABASE__SECRET__STRUCTURE),
	args: {
		source: {
			description: "source",
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		...
		return CONTROLLER__SECRET__CONTROLLER__DATABASE.create(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("2", __RELATIVE_FILEPATH, "CREATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
...
const UPDATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__SECRET__CONTROLLER__DATABASE.update(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("2", __RELATIVE_FILEPATH, "UPDATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data.map(SERIALIZER__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.serialize);
		});
	},
};
...
const DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__SECRET__CONTROLLER__DATABASE.delete(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write("2", __RELATIVE_FILEPATH, "DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data.map(SERIALIZER__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.serialize);
		});
	},
};

const CURSOR_UPDATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_UPDATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"source",
			source,
		);
		...
		return CONTROLLER__SECRET__CONTROLLER__DATABASE.cursor_update(
			context,
			{
				source,
			},
			...
			return {
				nodes: page.nodes.map(SERIALIZER__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.serialize),
...
const CURSOR_DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	type: CURSOR_PAGE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	args: {
		cursor: {
			description: "cursor",
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__SRC__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
			"CURSOR_DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter",
			"source",
			source,
		);
		if (
		...
		return CONTROLLER__SECRET__CONTROLLER__DATABASE.cursor_delete(
			context,
			{
				source,
			},
...
export {
	...
	CURSOR_UPDATE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE,
	CURSOR_DELETE__SECRET__MUTATION__GRAPHQL__INTERFACE__DATABASE,
};
