...
const CREATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "CREATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		...
		return CONTROLLER__SESSION__CONTROLLER__DATABASE.create(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "CREATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
...
const UPDATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "UPDATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__SESSION__CONTROLLER__DATABASE.update(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "UPDATE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data.map(SERIALIZER__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.serialize);
		});
	},
};
...
const DELETE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE = {
	...
	resolve: (source, mutation_arguments, context) => {
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("0", __RELATIVE_FILEPATH, "DELETE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:enter", "source", source);
		$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write(
			"0",
			__RELATIVE_FILEPATH,
		...
		return CONTROLLER__SESSION__CONTROLLER__DATABASE.delete(
			...
			$kernel.src.logger.io.LOGGER__IO__LOGGER__KERNEL.write("2", __RELATIVE_FILEPATH, "DELETE__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.resolve:success", "data", data);
			return data.map(SERIALIZER__SESSION__MUTATION__GRAPHQL__INTERFACE__DATABASE.serialize);
		});
	},
};
