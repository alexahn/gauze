...
class ProxyDatabaseModel extends $kernel.src.models.database.DatabaseModel {
...
const MODEL__PROXY__MODEL__DATABASE = new ProxyDatabaseModel(ROOT_CONFIG__PROXY__MODEL__DATABASE, CONFIG__PROXY__MODEL__DATABASE, MANAGER__DATABASE);
