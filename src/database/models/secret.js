...
class SecretDatabaseModel extends $kernel.src.models.database.DatabaseModel {
...
const MODEL__SECRET__MODEL__DATABASE = new SecretDatabaseModel(ROOT_CONFIG__SECRET__MODEL__DATABASE, CONFIG__SECRET__MODEL__DATABASE, MANAGER__DATABASE);
