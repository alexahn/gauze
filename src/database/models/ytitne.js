...
const MODEL__YTITNE__MODEL__DATABASE = new YtitneYtitneDatabaseModel(ROOT_CONFIG__YTITNE__MODEL__DATABASE, CONFIG__YTITNE__MODEL__DATABASE, MANAGER__DATABASE);
