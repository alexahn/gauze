...
class AgentRootDatabaseModel extends $kernel.src.models.database.DatabaseModel {
...
const MODEL__AGENT_ROOT__MODEL__DATABASE = new AgentRootDatabaseModel(ROOT_CONFIG__AGENT_ROOT__MODEL__DATABASE, CONFIG__AGENT_ROOT__MODEL__DATABASE, MANAGER__DATABASE);
