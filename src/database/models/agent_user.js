...
class Agent_UserDatabaseModel extends $kernel.src.models.database.DatabaseModel {
...
const MODEL__AGENT_USER__MODEL__DATABASE = new Agent_UserDatabaseModel(ROOT_CONFIG__AGENT_USER__MODEL__DATABASE, CONFIG__AGENT_USER__MODEL__DATABASE);
