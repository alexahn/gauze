...
class AgentUserDatabaseModel extends $kernel.src.models.database.DatabaseModel {
...
const MODEL__AGENT_USER__MODEL__DATABASE = new AgentUserDatabaseModel(ROOT_CONFIG__AGENT_USER__MODEL__DATABASE, CONFIG__AGENT_USER__MODEL__DATABASE, MANAGER__DATABASE);
