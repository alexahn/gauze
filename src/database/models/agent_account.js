...
const MODEL__AGENT_ACCOUNT__MODEL__DATABASE = new AgentAccountDatabaseModel(ROOT_CONFIG__AGENT_ACCOUNT__MODEL__DATABASE, CONFIG__AGENT_ACCOUNT__MODEL__DATABASE, MANAGER__DATABASE);
