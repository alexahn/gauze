...
- Read [Create a Definition](./definition.md) for the definition format.
- Read [Create a Migration](./create-a-migration.md) for migration and database config details.
- Read [Generate Project Code](./generate-project-code.md) for the general generation workflow.
