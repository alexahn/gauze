...
- Read [Create a Definition](./entity-definition.md) to define the entity first.
- Read [Generate Project Code](./entities.md) to generate the project modules from that definition.
